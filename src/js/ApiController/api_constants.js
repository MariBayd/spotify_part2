...
export const urlFeturedPlaylists = 'https://api.spotify.com/v1/browse/featured-playlists?';
...
export const  urlGenres = 'https://api.spotify.com/v1/recommendations/available-genre-seeds';
